...
// CS3: Enable SEND only after robot checkbox
(function(){
  document.addEventListener('DOMContentLoaded', function(){
    var c = document.getElementById('robot-check');
    var b = document.getElementById('support-submit');
    if (c && b){
      function sync(){ b.disabled = !c.checked; }
      sync();
