(function () {
  ...
  const I18N = {
    ...
    kh: {
        nav: { home: 'ទំព័រដើម', products: 'ផលិតផល', contact: 'ទាក់ទង', cart: 'កាបូប' },
        checkout: {
          bagTitle: 'កន្ត្រកទំនិញរបស់អ្នក',
          bagEmpty: 'កន្ត្រកទំនិញទំនេរ 😅 — មករកអ្វីដែលធ្វើឲ្យអ្នកសប្បាយចិត្តទៅ!',
          continue: 'បន្តរើសទំនិញ',
          checkoutTitle: 'គិតលុយ ❤️',
          buyer: 'ព័ត៌មានអ្នកទិញ',
          ...
          note: 'កំណត់ចំណាំ',
          provideTo: 'យើងនឹងផ្តល់ឱ្យទៅកាន់',
          contactVia: 'ទាក់ទងតាម',
          abaTitle: 'ABA KHQR',
          abaScan: 'ស្គែនបង់ប្រាក់ជាមួយកម្មវិធីធនាគារណាមួយ 📲',
          abaNote: 'ដើម្បីបានលឿន និងមានសុវត្ថិភាព ណែនាំឲ្យប្រើ ABA ក្នុងការទូទាត់។',
          remove: 'លុបចេញ',
          each: 'មួយ',
          deliveryFee: 'ថ្លៃដឹកជញ្ជូន',
          total: 'សរុប',
          purchase: 'បញ្ជាទិញឥឡូវ',
          ph: {
            name: 'ឧទាហរណ៍៖ ចាន់ មនី',
            phone: 'ឧទាហរណ៍៖ 0xx xxx xxx',
            address: 'ឧទាហរណ៍៖ ផ្លូវ ៣៧១ សង្កាត់បឹងទំពុន',
            province: 'ជ្រើសរើសខេត្ត',
            note: 'មានបញ្ហាអីអត់? ជួយប្រាប់ផង! ❤️'
          }
        },
        provinces: {
        ...
        footer: {
          ...
          address: 'អាសយដ្ឋាន',
          hours: 'ម៉ោងធ្វើការ',
          rights: 'រក្សាសិទ្ធិគ្រប់យ៉ាងដោយ Darila Official'
        },
        alerts: {
          needInfo: 'សូមបញ្ចូល ឈ្មោះ លេខទូរស័ព្ទ អាសយដ្ឋាន និង ខេត្ត/រាជធានី មុននឹងបន្ត។',
          bagEmpty: 'កន្ត្រកទំនិញទំនេរ — សូមបញ្ចូលទំនិញជាមុនសិន!',
          sent: '🎉 បញ្ជាទិញត្រូវបានផ្ញើ! ក្រុមការងារពួកយើងនឹងទាក់ទងអ្នកវិញឆាប់ៗនេះ។',
          error: 'អូហ៌… មានបញ្ហាបន្តិច—សូមព្យាយាមម្ដងទៀត។'
        }
      , 
        provinces: {
        pp: 'រាជធានីភ្នំពេញ', sr: 'សៀមរាប', bb: 'បាត់ដំបង', pv: 'ព្រះវិហារ',
